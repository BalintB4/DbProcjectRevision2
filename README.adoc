...
Orthology: ist nur wichtig, welche gene in der Maus und im Menschen ortholog sind und wie sie es sind(type)
...
Endprodukt Query (wie auf dem Zettel in der Mappe von Schnalzenberger)
...
Essential Genes Tabelle -> was bedeutet ncbi_id und ensembl

Orthology -> was ist der type?

SynLeth -> was ist statistic_score und cell line

OMA -> was für ids brauchen wir
